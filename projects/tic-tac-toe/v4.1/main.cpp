...
void Player::setMarker(char m, bool isFirstPlayer) {
    if(isFirstPlayer) {
...
int *Board::getSlotRowAndColumn(char slot) {
    int row, column = 0; 
...
void Board::placeMarker(char slot, Player *current) {
...
bool Board::slotIsValid(char slot) {
